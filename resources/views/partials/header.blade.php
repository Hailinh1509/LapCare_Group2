            ...
            <div class="inner">
                <div class="pill">
                    <svg viewBox="0 0 24 24" fill="currentColor">
                        <path d="M12 1a4 4 0 014 4h3a3 3 0 013 3v6a3 3 0 01-3 3h-3a4 4 0 01-4 4H6a3 3 0 01-3-3V5a4 4 0 014-4h5z"/>
                    </svg>
...
<header>
    <nav class="nav">
        ...
        <!-- Logo -->
        <a href="{{ Auth::check() ? route('home.logged') : route('home') }}"
        ...
        <div class="main-menu">
            ...
            {{-- Tin tức --}}
            <a href="{{ route('news.index') }}" class="action">
            ...
            <a href="{{ route('contact') }}" class="action">
                <svg viewBox="0 0 25 25" fill="currentColor">
                    <path d="M6.62 10.79a15 15 0 006.59 6.59l2.2-2.2a1 1 0 011.11-.21c1.2.48 2.53.74 3.91.74a1 1 0 011 1v3.5a1 1 0 01-1 1C10.61 22 2 13.39 2 3.5a1 1 0 011-1H6.5a1 1 0 011 1c0 1.38.26 2.71.74 3.91a1 1 0 01-.21 1.11l-2.41 2.27z"/>
                </svg>
            ...
            <form class="search" method="GET" action="{{ route('home') }}">
                <svg viewBox="0 0 20 20" fill="currentColor">
                    <path d="M10 2a8 8 0 015.292 13.708l4 4-1.414 1.414-4-4A8 8 0 1110 2z"/>
                </svg>
            ...
            @if(Auth::check())
                <div class="action user-menu">
                    ...
                    <span class="label">
                        Xin chào, {{ Str::of(Auth::user()->name)->afterLast(' ') }}
                    </span>
            ...
            @else
                <a href="{{ route('login') }}" class="action">
                    <svg viewBox="0 0 23 23" fill="currentColor">
                        <path d="M12 12a5 5 0 100-10 5 5 0 000 10zm0 2c-5 0-9 3-9 6v2h18v-2c0-3-4-6-9-6z"/>
                    </svg>
